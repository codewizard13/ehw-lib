...
- Display ID-based URL for current post under the post permalink at top. The ID-based post URL is read-only so editors can select it, but cannot edit it.
- Created this for ELSM with help of WordPress Redditors
